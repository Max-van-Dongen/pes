...
//	if (RxData[numREG] == 0x01) {
//
//		HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_SET);
//	}
//	if (RxData[numREG] == 0x02) {
//
//		HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET);
//	}
//
//	if (RxData[numREG] == 0x03) {
//		funcToRun = 3;
//		setServoAngle(180);
//		HAL_Delay(5000);
//		setServoAngle(0);
...
//		HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_SET);
	...
	{
	        txcount = 0;
	        uint8_t dataToTransmit; // Temporary buffer to decide what to transmit

	        // Check if the requested frame is 0x01 to return funcToRun value
	        if (RxData[0] == 0x01)
	        {
